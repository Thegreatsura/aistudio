...
import { type SortableWorkspaceColumn, type SortDirection } from "@/hooks/use-admin-workspace-filters"
...
const columnConfigs: ColumnConfig[] = [
  { id: "workspace", label: "Workspace", sortField: "name", width: 220, minWidth: 180 },
  { id: "owner", label: "Owner", width: 220, minWidth: 180 },
  { id: "memberCount", label: "Members", sortField: "memberCount", width: 90, minWidth: 70, maxWidth: 100 },
  ...
  { id: "totalSpend", label: "Spend", sortField: "totalSpend", width: 100, minWidth: 80, maxWidth: 120 },
  { id: "createdAt", label: "Created", sortField: "createdAt", width: 120, minWidth: 100, maxWidth: 140 },
