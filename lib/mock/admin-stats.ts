  ...
  for (let i = 0; i < limit * 2; i++) {
    ...
    switch (type) {
      case "user_joined":
        ...
        metadata = { userId: user.id, userName: user.name, workspaceId: workspace.id, workspaceName: workspace.name }
        break
      ...
      case "image_generated":
        ...
        metadata = { userId: user.id, userName: user.name, workspaceId: workspace.id, workspaceName: workspace.name, imageCount }
        break
      case "plan_upgraded":
        ...
        metadata = { workspaceId: workspace.id, workspaceName: workspace.name, planFrom: plans[fromIndex], planTo: plans[toIndex] }
        break
      case "user_invited":
